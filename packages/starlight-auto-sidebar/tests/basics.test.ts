...
test.describe('updates autogenerated sidebar groups', () => {
  ...
  test('updates the collapsed state of a directory for collapsed an autogenerated group and its subgroups', async ({
    ...
    expect(await page.getSidebarGroupState(['collapsed', 'sub-1'])).toBe('expanded')
    expect(await page.getSidebarGroupState(['collapsed', 'sub-2'])).toBe('collapsed')
  })
...
test.describe('sorts autogenerated sidebar groups', () => {
  ...
  test('sorts by `label`', async ({ getPage }) => {
    const page = await getPage()
    await page.go()
    ...
    expect(items).toMatchSidebar([
      ...
      { label: 'z (modified)' },
      {
        ...
        items: [
          ...
          {
            label: 'sub-1',
            items: [{ label: 'a-sub-1/sub-1/b (modified)' }, { label: 'z-sub-1/sub-1/a (modified)' }],
          },
  ...
  test('sorts by `reverse-label`', async ({ getPage }) => {
    const page = await getPage()
    await page.go()
    ...
    expect(items).toMatchSidebar([
      ...
      { label: 'c' },
      {
        ...
        items: [
          ...
          {
            label: 'sub-1',
            items: [{ label: 'z-sub-1/sub-1/a (modified)' }, { label: 'a-sub-1/sub-1/b (modified)' }],
          },
          { label: 'a-sub-1/b (modified)' },
        ],
      },
...
test.describe('updates prev/next links of autogenerated sidebar group pages', () => {
  test('preserves pagination when the current link is removed from the sidebar', async ({ getPage }) => {
    const page = await getPage()
    ...
    await page.expectPrevNextLinks('updates', [
      {
        url: '/sub-4/a/',
        expected: {
          prev: { href: '/unrelated-page/', label: 'Unrelated Page' },
        },
      },
    ])
  })
  ...
  test('sets prev/next links when sorting by `label`', async ({ getPage }) => {
    const page = await getPage()

    await page.expectPrevNextLinks('sort-label', [
      {
        url: '/b/',
        expected: {
          prev: { href: '/sort-label/c/', label: 'c' },
          next: { href: '/sort-label/sub-2/a/', label: 'sub-2/a' },
        },
      },
      {
        url: '/sub-2/a/',
        expected: {
          prev: { href: '/sort-label/b/', label: 'a (modified)' },
          next: { href: '/sort-label/sub-2/b/', label: 'sub-2/b' },
        },
      },
      {
        url: '/sub-1/sub-1/b/',
        expected: {
          prev: { href: '/sort-label/sub-1/b/', label: 'a-sub-1/b (modified)' },
          next: { href: '/sort-label/sub-1/sub-1/a/', label: 'z-sub-1/sub-1/a (modified)' },
        },
      },
    ])
  })

  test('sets prev/next links when sorting by `reverse-label`', async ({ getPage }) => {
    const page = await getPage()

    await page.expectPrevNextLinks('sort-reverse-label', [
      {
        url: '/sub-1/sub-1/a/',
        expected: {
          prev: { href: '/sort-reverse-label/sub-1/a/', label: 'z-sub-1/a (modified)' },
          next: { href: '/sort-reverse-label/sub-1/sub-1/b/', label: 'a-sub-1/sub-1/b (modified)' },
        },
      },
      {
        url: '/a/',
        expected: {
          prev: { href: '/sort-reverse-label/sub-1/b/', label: 'a-sub-1/b (modified)' },
          next: { href: '/sort-reverse-label/sub-2/b/', label: 'sub-2/b' },
        },
      },
    ])
  })
